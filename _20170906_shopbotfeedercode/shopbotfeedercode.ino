...
void loop() {
    ...
    if (sb09 > 300 && BUSY==false) {       // if input pin 9 is high and shopbot is not busy
        ...
        if (sb10 < 300 && sb11 > 300 && sb12 < 300) {       // 10,11,12 = 0,1,0
            load_nextScrew();
        }
        else if (sb10 > 300 && sb11 < 300 && sb12 < 300) {  // 10,11,12 = 1,0,0
            load_nextVoxel();
        }
        else if (sb10 < 300 && sb11 < 300 && sb12 > 300) {  // 10,11,12 = 0,0,1
            load_nextNut(); 
        }
        else if (sb10 > 300 && sb11 > 300 && sb12 < 300) {  // 10,11,12 = 1,1,0
            load_bolt();
        }
        else{
